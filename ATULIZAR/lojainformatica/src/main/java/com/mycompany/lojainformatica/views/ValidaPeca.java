 ...
 * @author R I C H
 */
public class ValidaPeca extends javax.swing.JFrame {

    /**
     * Creates new form ValidaPeca
     */
    public ValidaPeca() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValidaPeca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ValidaPeca().setVisible(true);
            }
        });
    }
